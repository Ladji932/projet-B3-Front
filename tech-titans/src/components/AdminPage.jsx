...
const AdminPage = ({ getToken }) => {
    ...
    return (
        <div className={`flex justify-center items-center min-h-screen ${isDarkMode ? 'bg-black' : 'bg-white'} p-5`}>
            <div className={`shadow-xl rounded-lg p-6 w-full max-w-2xl ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}>
            <h1 className={`text-3xl font-bold mb-6 ${isDarkMode ? 'text-white' : 'text-black'}`}>Page Administrateur</h1>

                {adminData ? (
                    <div className="space-y-6">
                        <div className="bg-gray-50 p-4 rounded-lg shadow-sm {isDarkMode ? 'bg-white' : 'bg-black'}">
