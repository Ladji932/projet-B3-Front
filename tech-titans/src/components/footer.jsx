...
function Footer() {
  ...
  return (
    <footer className={`w-full mx-auto ${isDarkMode ? 'bg-gray-800' : 'bg-beige'} py-8 px-6`}>
      ...
      <div className="max-w-7xl mx-auto border-t border-white/10 mt-4 pt-4 flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
